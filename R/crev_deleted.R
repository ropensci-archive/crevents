...
#' 
#' # filter with source
#' crev_deleted(rows = 10, source = "reddit")
#' crev_deleted(rows = 10, source = "twitter")
#' 
#' # on the first of March 2017s
#' crev_deleted(rows=10, from_collected_date = "2017-03-01", 
#'   until_collected_date = "2017-03-01")
#'   
#' # in the month of March 2017
#' crev_deleted(rows=10, from_occurred_date = "2017-03-01", 
...
#' crev_deleted(rows = 10, obj_id_prefix = "10.1186")
#' 
#' # Up to ten events for a given DOI
#' crev_deleted(rows = 10, obj_id = "10.1186/s40536-017-0036-8")
#' 
#' # Use cursor
#' res <- crev_deleted(rows = 10)
#' crev_deleted(rows = 10, cursor = res$message$`next-cursor`)
#' 
#' # facet
